...
<%
DaoJB jb = (DaoJB)session.getAttribute("jbbb");
%>

   <div style="margin-top:2%; margin-left:35%; ">
<form class="pure-form pure-form-aligned" action="../../saleServlet?method=updateagency1&name=<%=jb.getUsername() %>" method="post">
    <fieldset>
        <table style="border-collapse:separate; border-spacing:0px 10px;">
        <tr>
            <td style="align:left"><label for="name">&#12288;经销商名</label> </td>
            <td><input type="text" id="username" name="username" value=<%=jb.getUsername() %> onBlur="return checkName()"> </td>
            <td><span id="tips_username" class="pure-form-message-inline">*经销商名由6-18位字符组成</span> </td>
        </tr>  
               
         <tr>
            <td><label for="name">联系方式 </td>
