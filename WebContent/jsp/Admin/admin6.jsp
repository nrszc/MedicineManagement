    ...
    <div id="menu">
        <div class="pure-menu">
            ...
            <ul class="pure-menu-list">
                ...
                <li class="menu-item-divided pure-menu-selected"><a href="../../saleServlet?method=findagency" class="pure-menu-link">查看经销商</a></li>
            </ul>
        </div>
    </div>
...
<center>
        <div class="content" style="margin-top:3%; margin-left:10%;">
    ...
    <tbody>
  <%
  String sb = (String)session.getAttribute("list6");
  out.print(sb);
  %>
    </tbody>
</table> 
