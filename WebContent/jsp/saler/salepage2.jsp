    ...
    <div id="menu">
        <div class="pure-menu">
            ...
            <ul class="pure-menu-list">
                <li class="menu-item-divided pure-menu-selected"><a href="../../saleServlet?method=salernews" class="pure-menu-link">个人信息</a></li>
...
<form class="pure-form pure-form-aligned" action="../../saleServlet?method=updatesaler" method="post">
    <fieldset>
