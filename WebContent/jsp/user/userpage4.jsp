...
list = (ArrayList<DaoCart>)session.getAttribute("list1");
...
<div id="layout">
    ...
    <div id="menu" style="font-size:17.6px;">
        <div class="pure-menu">
            ...
            <ul class="pure-menu-list">
                ...
                <li class="pure-menu-item"><a href="../../Servlet?method=myorder" class="pure-menu-link"  style="text-decoration:none;">我的订单</a></li>
            </ul>
        </div>
    </div>
	...
	<table id="cartTable">
		...
		<%
		 ...
		 if(list!=null&&list.size()>0)
         {
             ...
             {
            	 DaoCart cart = list.get(i);
            	 Float p = Float.parseFloat(cart.getPrice())*Float.parseFloat(cart.getNum());
		%>
			<tr>
				<td class="goods"><img src="../../images/<%=cart.getMimg() %>" alt=""/><span><%=cart.getMname() %></span></td>
				<td class="price"><%=cart.getPrice() %></td>
				<td class="count"><span><%=cart.getNum() %></span></td>
				<td class="subtotal"><%=p %></td>
				<td class="operation"><span class="delete"><a href="../../Servlet?method=deletecart&mNo=<%=cart.getmNo()%>">删除</a></span>
				<span class="delete"><a href="../../Servlet?method=buy&mNo=<%=cart.getmNo()%>">购买</a></span>
				</td>
			</tr>
		<%
             }
